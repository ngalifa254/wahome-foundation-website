...
// Corrected Partner Logos Imports
...
// ─── COMPACT PAGE HERO (Integrates Directly Into Sub-Page Layouts) ─────────────
  ...
  return (
    <div className="mb-8">
      <div className="rounded-2xl bg-[#F4F8FA] border border-slate-200/80 p-6 sm:p-8 text-left shadow-sm">
        <h1
          className="font-serif text-2xl sm:text-3xl font-bold text-slate-900 leading-tight tracking-tight mb-1.5"
...
// ─── PLAIN WHITE INSET FOOTER (Inspired by Sublime.app) ────────────────────────
...
// ─── ABOUT PAGE (Unified Grid Alignment) ──────────────────────────────────────
    ...
    <div className="bg-white pt-28 pb-16">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="space-y-16">
          ...
          <section className="bg-[#EAF6FA]/60 rounded-3xl p-8 sm:p-10 border border-[#D6E4EA]">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-[#5C6B72] leading-relaxed text-center text-sm sm:text-base">
          ...
          <section className="bg-white">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                <div key={b.role} className="text-center p-4 rounded-2xl bg-[#F8FAFC] border border-[#E2E8F0]">
                  <div className="w-20 h-20 rounded-full bg-white flex items-center justify-center mx-auto mb-3 shadow-sm border border-[#D6E4EA]">
                    <Users className="w-8 h-8 text-[#1D95B8]" />
                  </div>
                  <h3
                    className="font-bold text-[#10202B] font-serif text-base"
                    style={{ fontFamily: "'Montserrat', sans-serif" }}
                  >
                    {b.name}
                  </h3>
                  <p className="text-xs text-[#1D95B8] font-medium">{b.role}</p>
                </div>
              ))}
            </div>
          </section>

          {/* Powered By Partners Section (50% Larger, Full Color) */}
          <section className="pt-10 border-t border-[#EAF6FA]">
...
// ─── SCHOLARSHIP PAGE (Unified Grid Alignment) ────────────────────────────────
    ...
    <div className="bg-white pt-28 pb-16">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="space-y-16">
          ...
          <section className="bg-[#EAF6FA]/40 rounded-3xl p-8 border border-[#D6E4EA]">
            <div className="text-center mb-10">
              <SectionTag>Meet Our Scholars</SectionTag>
              <h2
                className="font-serif text-2xl sm:text-3xl font-bold text-[#10202B]"
              ...
              {[
                {
                  ...
                  message:
                    "The Foundation came at a defining time when I was uncertain of my future education. They helped me join High School and gave me hope of pursuing career in Agriculture Engineer.",
                  photo: alexPhoto,
                },
                {
                  name: "Jedidah Watetu",
                  ...
                  message:
                    "I got scholarship to join High School through the intervention of the Wahome Foundation. Aspiring to be a Doctor in the future.",
                  photo: jedidahPhoto,
                },
              ].map((s) => (
                <div
                  key={s.name}
                  className="flex flex-col sm:flex-row bg-white rounded-2xl border border-[#D6E4EA] overflow-hidden shadow-sm text-left"
                >
                  <img
                    src={s.photo}
                    alt={s.name}
                  ...
                  <div className="p-6 flex flex-col justify-center">
                    <h4 className="font-bold text-[#10202B] text-lg">{s.name}</h4>
                    <p className="text-xs text-[#1D95B8] font-bold uppercase mb-2">{s.meta}</p>
                    <p className="text-xs text-[#5C6B72] leading-relaxed">{s.message}</p>
                  </div>
                </div>
              ))}
            </div>
...
// ─── WELLS OF HOPE PAGE (Unified Grid Alignment) ─────────────────────────────
    ...
    <div className="bg-white pt-28 pb-16">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center text-left">
          ...
          <div className="rounded-3xl overflow-hidden bg-[#B9D3DE] aspect-[4/3] shadow-md">
            <img
...
// ─── PRIZE GIVING PAGE (Unified Grid Alignment) ──────────────────────────────
        ...
        <div className="space-y-12 text-left">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2
                className="font-serif text-3xl font-bold text-[#10202B] mb-4"
                style={{ fontFamily: "'Montserrat', sans-serif" }}
              >
                Excellence deserves to be seen
              </h2>
              <p className="text-[#5C6B72] text-sm sm:text-base leading-relaxed mb-4">
...
// ─── MENTORSHIP PAGE (Unified Grid Alignment) ─────────────────────────────────
